		...
		$this->html = '
			...
			<div class="alert alert-info">
				<p>'
					...
					.$this->l('You should often consult this screen, as it allows you to quickly monitor your shop\'s viability. It also allows you to monitor multiple time periods.').'<br/>'
